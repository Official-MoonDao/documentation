...
The [Open Lunar Foundation](Open%20Lunar%20Foundation.md) has verbally expressed support for this analysis, but has made no commitments as of yet. The [Open Lunar Foundation](Open%20Lunar%20Foundation.md) is a non-profit organization that is dedicated to the development of the Moon. MoonDAO is a community-based organization that is also dedicated to the development of the Moon. It will be valuable to establish how the MoonDAO community and [Open Lunar](Open%20Lunar%20Foundation.md) could work together to receive [[NASA]] funding. This will be especially important as MoonDAO continues into stage 3 of the [roadmap](Roadmap.md).
...
1. We don't submit time, or we don't receive an award. The consequence of this is that we miss out on an opportunity to bring funding to the DAO, and would not be able to compensate contributors for their engineering effort. All the materials generated from this proposal could be reused in future work.
   ...
   > This risk was realized―MoonDAO did not submit a proposal.

1. There are insurmountable legal roadblocks that prevent MoonDAO from being awarded [[NASA]] funds. It would be helpful to understand what obstacles lie in the way for MoonDAO to receive [[NASA]] funding. For example, an acceptable outcome would be to learn for certain whether MoonDAO can be awarded funds directly,  and if it is necessary to use another entity (such as [Open Lunar Foundation](Open%20Lunar%20Foundation.md) or another partner) as a legal proxy. The MIDAO status is not complete, so MoonDAO doesn't currently have an official entity in real life that can receive funds directly.
...
|2023-08-14|Share the planned objectives, methods, and hypotheses with the MoonDAO community for review and feedback. Begin analysis.|
