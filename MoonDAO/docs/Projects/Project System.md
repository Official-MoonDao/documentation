...
After all the members have input their distribution, we publish the results and run this [script]([⚠️⚠️⚠️UPDATE TO JADE's SCRIPT⚠️⚠️⚠️]) where we calculate the distribution for each project.
